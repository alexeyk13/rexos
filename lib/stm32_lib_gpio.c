...
void stm32_lib_gpio_enable_pin(unsigned int pin, GPIO_MODE mode)
{
    ...
    {
    case GPIO_MODE_OUT:
        ack(object_get(SYS_OBJ_CORE), STM32_GPIO_ENABLE_PIN, pin, STM32_GPIO_MODE_OUTPUT_PUSH_PULL_50MHZ, false);
        break;
    case GPIO_MODE_IN_FLOAT:
        ack(object_get(SYS_OBJ_CORE), STM32_GPIO_ENABLE_PIN, pin, STM32_GPIO_MODE_INPUT_FLOAT, false);
        break;
    case GPIO_MODE_IN_PULLUP:
        ack(object_get(SYS_OBJ_CORE), STM32_GPIO_ENABLE_PIN, pin, STM32_GPIO_MODE_INPUT_PULL, true);
        break;
    case GPIO_MODE_IN_PULLDOWN:
        ack(object_get(SYS_OBJ_CORE), STM32_GPIO_ENABLE_PIN, pin, STM32_GPIO_MODE_INPUT_PULL, false);
        break;
    }
    ...
    {
    case GPIO_MODE_OUT:
        ack(object_get(SYS_OBJ_CORE), STM32_GPIO_ENABLE_PIN, pin, STM32_GPIO_MODE_OUTPUT | GPIO_OT_PUSH_PULL | GPIO_SPEED_HIGH | GPIO_PUPD_NO_PULLUP, AF0);
        break;
    case GPIO_MODE_IN_FLOAT:
        ack(object_get(SYS_OBJ_CORE), STM32_GPIO_ENABLE_PIN, pin, STM32_GPIO_MODE_INPUT | GPIO_SPEED_HIGH | GPIO_PUPD_NO_PULLUP, AF0);
        break;
    case GPIO_MODE_IN_PULLUP:
        ack(object_get(SYS_OBJ_CORE), STM32_GPIO_ENABLE_PIN, pin, STM32_GPIO_MODE_INPUT | GPIO_SPEED_HIGH | GPIO_PUPD_PULLUP, AF0);
        break;
    case GPIO_MODE_IN_PULLDOWN:
        ack(object_get(SYS_OBJ_CORE), STM32_GPIO_ENABLE_PIN, pin, STM32_GPIO_MODE_INPUT | GPIO_SPEED_HIGH | GPIO_PUPD_PULLDOWN, AF0);
        break;
    }
#endif
}
...
{
    ack(object_get(SYS_OBJ_CORE), STM32_GPIO_DISABLE_PIN, pin, 0, 0);
}
