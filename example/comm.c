...
{
    HANDLE tx_stream;
    tx_stream = get(app->usbd, HAL_CMD(HAL_USBD_IFACE, IPC_GET_TX_STREAM), USBD_IFACE(0, 0), 0, 0);
    app->comm.rx_stream = get(app->usbd, HAL_CMD(HAL_USBD_IFACE, IPC_GET_RX_STREAM), USBD_IFACE(0, 0), 0, 0);
